...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("final_classification", sa.String(50), nullable=False),
        sa.Column("agreement_status", sa.String(30), nullable=False),
        sa.Column("requires_human_review", sa.Boolean(), nullable=False),
        sa.Column("disagreement_reason", sa.String(250)),
